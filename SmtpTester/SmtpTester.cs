    ...
    public partial class SmtpTester : Form
    {
        ...
        protected async void btnTestEmail_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                await smtpClient.TestEmail(chkDefaultCredentials.Checked,
                    txtServer.Text, Convert.ToInt32(txtPort.Text), chkEnableTLS.Checked, txtUsername.Text, txtPassword.Text,
                    txtFrom.Text, to, cc, bcc, txtSubject.Text, txtBody.Text);
